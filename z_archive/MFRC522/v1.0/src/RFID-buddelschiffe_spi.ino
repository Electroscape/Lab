...
/*==DEFINE==================================================================================================*/
// RFID
#define RFID_NR_OF_READERS      3     /* Anzahl der angeschlossenen Reader                                  */
...
void Relayboard_Init() {
  ...
  relay.digitalWrite(EXP_LICHT_PIN, LOW); //Licht an
  relay.digitalWrite(EXP_SCHW_LI_PIN, HIGH); //Licht an
  delay(500);
...
void RFID_Loop() {
    ...
    Serial.println("statuses of RFID_KeywordsAreAllRight, RFID_Finished");
    Serial.print(RFID_KeywordsAreAllRight());
